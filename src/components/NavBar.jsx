...
<div >
    ...
    <NavDropdown title="Subscription" id="basic-nav-dropdown">
      ...
      <NavDropdown title="Products" id="basic-nav-dropdown">
        <NavDropdown.Item href="#action/2.1">Groceries</NavDropdown.Item>
        <NavDropdown.Item href="#action/2.2">Electronics</NavDropdown.Item>
        <NavDropdown.Item href="#action/2.3">Home Decor</NavDropdown.Item>
      ...
      <NavDropdown title="Deals" id="basic-nav-dropdown">
        ...
        <NavDropdown.Item href="#action/3.2">Discount Coupons</NavDropdown.Item>
